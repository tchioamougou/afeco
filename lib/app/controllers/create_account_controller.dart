...
class CreateAccountController extends GetxController {
  ...
  Future<void> submitForm() async {
    ...
    try {
      StoreModel sm = StoreModel(businessName: businessController.value.text,
          ...
          lng: double.parse(address.lon??'0'));
      await _appWriteController.createDocument(AppWriteCollection.storeCollections,sm.toJson() );
    } catch (e) {
