...
class SaveController extends GetxController {
  ...
  Rx<TextEditingController> originalPriceController = TextEditingController().obs;
  Rx<TextEditingController> newPriceController = TextEditingController().obs;
  Rx<TextEditingController> quantityPriceController = TextEditingController().obs;
  ...
  Future<void> addNewSurprise() async {
    ...
    try {
      Bag gp =Bag(name: 'Surprise Bags',
          ...
          pickupDateStart: Utils.setDateTime(pickupDate.value, pickupDateFrom.value),
          ...
          stores: "67094db4328d455fa2e0"
      );
      await _appWriteController.createDocument(AppWriteCollection.bagsCollections,gp.toJson() );
      EasyLoading.dismiss();
      Get.back();
    } catch (e) {
