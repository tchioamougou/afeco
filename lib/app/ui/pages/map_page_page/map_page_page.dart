                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ElevatedButton(
                          onPressed: () {},
                          child: FaIcon(FontAwesomeIcons.filter, color: Constants.buttonColor,),
                        ...
                        ElevatedButton(
                            onPressed: () {},
                            child: FaIcon(FontAwesomeIcons.eyeLowVision,color: Constants.buttonColor,),style: ElevatedButton.styleFrom(
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(5),
                          ),
                          padding: EdgeInsets.zero
